...
void buildSymtab(TreeNode* syntaxTree) {
    ...
    if (not isError) {
        ...
        printSymtab();
        cout << "******print over***********\n" << endl;
        cout << "symtab build over, everything is ok! congratulations!" << endl << endl;
    } else {
        cout << "you have " << isError << " errors in symtab, please check!" << endl << endl;
    }
}
...
void typeCheck(TreeNode *syntaxTree) {
    ...
    if (typeError) {
        cout << "type check over, your have " << typeError << " errors, please check!" << endl << endl;
    } else {
        cout << "type check over, everything is ok! congratulations!" << endl << endl;
    }
}